...
\begin{document}
	\begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
		...
		\textbf{{\Large  Maxime St-Pierre}} & \textbf{July 19th, 2019} \\
	...
	\begin{itemize}
		\item {\bf Programming Language:} Bash, C++, Go, JavaScript, Node.js, PHP, Python, LaTeX
		\item {\bf Software:} Altium, Ansible, Atom, Django, Docker, Emacs, Git, Linux, MacOS, OpenCV, ROS, Vim
	\end{itemize}
\resheading{Free and Open Source Software Contribution}
\begin{itemize}
	\item Sous-Chef
	\begin{itemize}
		\item Web Application to help meal-on-wheels organisation to organise meals and deliver them to the clients.
		\item \href{https://github.com/savoirfairelinux/sous-chef}{Source Code: https://github.com/savoirfairelinux/sous-chef}
	\end{itemize}
	\item SFLvault and SFLvault server
	\begin{itemize}
		\item Working on the redesign of the sfl vault networked credentials store and authentication manager
		\item Source Code: 
		\begin{itemize}
			\item \href{https://github.com/savoirfairelinux/sous-chef}{Client Source Code}
			\item \href{https://github.com/savoirfairelinux/sflvault-server}{Server Source Code}
		\end{itemize}
	\end{itemize}
	\item For more contribution to Free and Open Source software please look at my \href{https://github.com/maximest-pierre}{github profile}
\end{itemize}
